...
export function Basket() {
  ...
  // const add = (product: Product): void => { dispatch(actions.addProduct(product)) };
  // const drop = (id: number): void => { dispatch(actions.dropProduct(id)) };
  // const removeAll = (): void => { dispatch(actions.removeAll) };
